        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={isLoading || !jdFile || !cvFile}
              className="w-full"
            >
              {isLoading ? (
                <>
            ...
            {result.demoMode && (
              <div className="rounded-md bg-yellow-100 border border-yellow-300 p-4 text-yellow-800 text-sm shadow-sm">
                ...
                <ul className="list-disc list-inside mt-2">
                  ...
                  <li>
                    Make sure <code>ollama</code> is installed and running
                  </li>
                  <li>
                    Pull and run the <strong>phi</strong> model locally via{" "}
                    <code>ollama run phi</code>
                  </li>
                </ul>
              </div>
            )}
